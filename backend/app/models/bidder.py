...
class BidderDocument(Base):
    ...
    # --- Document Intelligence & Tampering Risk Analysis ---
    tampering_risk = Column(String(20), default="LOW", nullable=False)  # LOW, MEDIUM, HIGH
    tampering_indicators = Column(Text, nullable=True)  # JSON array of detected indicators
    quality_status = Column(String(50), default="READABLE", nullable=False)  # READABLE, LOW_RESOLUTION, UNREADABLE, INCOMPLETE
    ...
    versions = relationship(
        ...
        foreign_keys="DocumentVersion.bidder_document_id",
    )
