...
class Tender(Base):
    ...
    procurement_mode = Column(String(50), default="L1", nullable=False)  # L1, direct_purchase, reverse_auction, qcbs
    category = Column(String(100), default="Equipment", nullable=False)  # Equipment, Services, Safety, Chemicals, Works, Other
    estimated_value = Column(Float, nullable=True)  # in INR (Crores / Lakhs)
    commercial_formula = Column(String(255), default="base_plus_tax_freight_loading", nullable=False)
