...
SUPPORTED_CATEGORIES = [
    ...
    "make_in_india", "oem_authorization", "other",
]
...
BIDDER_DOCUMENT_TYPES = [
    ...
    "financial_statement", "turnover_certificate", "make_in_india",
...
EXPECTED_FIELDS_BY_TYPE: Dict[str, List[str]] = {
    ...
    "oem_authorization": ["company_name", "oem_authorization_number", "oem_name", "valid_upto"],
    "other": ["company_name"],
}
