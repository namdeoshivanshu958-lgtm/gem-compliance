...
# OEM authorization/dealership letter reference number -> record.
# "status" must be exactly "Valid" to pass the OEM authorization rule.
OEM_AUTHORIZATION_DATABASE = {
    "OEM/AUTH/2025/00981": {
        "company_name": "COMPLIANT TRADERS PRIVATE LIMITED",
        "oem_name": "Bharat Heavy Electricals Limited",
        "status": "Valid",
        "valid_upto": "2027-06-30",
    },
    "OEM/AUTH/2024/00456": {
        "company_name": "RELIABLE ENGINEERING WORKS",
        "oem_name": "Larsen & Toubro Ltd",
        "status": "Valid",
        "valid_upto": "2026-11-30",
    },
    "OEM/AUTH/2021/00112": {
        "company_name": "STRUGGLING SUPPLIES LLP",
        "oem_name": "Kirloskar Brothers Ltd",
        "status": "Expired",
        "valid_upto": "2023-04-30",
    },
}
