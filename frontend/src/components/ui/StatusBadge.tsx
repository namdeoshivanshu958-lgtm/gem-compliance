...
export default function StatusBadge({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1.5 whitespace-nowrap rounded-[4px] border font-semibold leading-none tracking-wider uppercase',
    ...
    >
      {icon ? (
        ...
        <span
          className={cn('h-1.5 w-1.5 shrink-0 rounded-sm', DOT_STYLES[tone])}
          aria-hidden="true"
        />
      ) : null}
      <span>{children}</span>
